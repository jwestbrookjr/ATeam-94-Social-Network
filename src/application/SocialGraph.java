...
/**
 * Filename: UndirectedGraph.java Project: Authors:
 * 
...
public class SocialGraph implements GraphADT {
	...
	ArrayList<GraphNode> vertices = new ArrayList<GraphNode>(0);
...
///////////////////////////////////////////////////////////////////////////////
	...
	public void addVertex(String vertex) {
		...
		// Vertex is already in the graph; do not add.
	...
	public void removeEdge(String vertex1, String vertex2) {
		GraphNode v1 = search(vertex1);
		GraphNode v2 = search(vertex2);
		// IF either vertex is not in Graph do not remove anything
		if (v1 == null | v2 == null)
			return;
...
////////////////////////////////////////////////////////////////////////////////
	...
	/*
	 * Mark all nodes as unvisited and predecessor for shortest path algorithm
	 * to null.
	 */
...
///////////////////////////////////////////////////////////////////////////////
	...
	/**
	 * Basic depth first search from a vertex in a graph All vertices that can
	 * be reached from v will be marked visited
	 * 
	...
	/**
	 * Call DFS until all vertices are marked as visited each time you call DFS
	 * add 1 to the number of connected groups in the graph
	 * 
...
///////////////////////////////////////////////////////////////////////////////    
	 ...
	 * its in the graph, otherwise returns null
	 * 
	 * @param data
...
///////////////////////////////////////////////////////////////////////////////
	...
	public void printGraph() {
		...
		for (int i = 0; i < numVertices; i++) {
			...
			System.out.print("User: " + currV.getUserName() + " Friends: ");
			if (neighbors.size() == 0) {
