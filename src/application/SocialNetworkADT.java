...
public interface SocialNetworkADT {
	 ...
	 * 
	 * @param file - file used to create a SocialNetwork.
	 ...
	 * is made via the GUI. if: command == a if: 1 name after add user to graph
	 * else if: 2 names after add edge(friendship) between two users else throw
	 * InvalidInputFileFormatException else if: command == 'r' if: 1 name after
	 * remove user(and his friendships) from graph else if: 2 names after remove
	 * edge(friendship) between the two users else throw
	 * InvalidInputFileFormatException else if: command == 's' if: 1 name set
	 * user to central user in the SocialNetwork else throw
	 * InvalidInputFileFormatException else throw
	 * InvalidInputFileFormatException
	 * 
	 * @param command - add, remove or central user
	 * @param words   - array of strings containing then name(s) that come after
	 *                the command
	 * @throws InvalidInputFileFormatException - if input file does not valid
	 *                                         format
	 */
	 ...
	 * @throws IOException - if invalid file is passed as an argument.
	 */
	 ...
	 * 
	 * @return GraphNode - Vertex containing central user's information.
	 */
	 ...
	 * 
	 * @return SocialGraph - graph that contains user info.
	 */
