...
public interface GraphADT {
	 ...
	 * 
	 * For the example graph, A->[B, C], D->[A, B] getAdjacentVerticesOf(A)
	 * should return [B, C].
	 * 
	 * In terms of packages, this list contains the immediate dependencies of A
	 * and depending on your graph structure, this could be either the
	 * predecessors or successors of A.
	 * 
